...
public class TwelveDays {
    public static HashMap<Integer, String> twelveDaysSong = new HashMap<Integer, String>(){
        {
    ...
    //This verse method return the string part song according to day number
    static String verse(int verseNumber) {
        return twelveDaysSong.get(verseNumber);
    }

    //This sing method return the combine string of 12 days
    static String sing(int startSing, int endSing) {
        String addStringDaily = "";
        for (int i = startSing; i < endSing; i++) {
            addStringDaily += verse(i) + "\n";
        }
        addStringDaily += verse(endSing);
        return addStringDaily;
    }

    public static void main(String[] args)
    {
        String christmasSong= sing(1,12);
        System.out.print(christmasSong);
    }
}